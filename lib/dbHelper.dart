...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    await db.execute(
        'CREATE TABLE customerTable (id INTEGER PRIMARY KEY, name TEXT, balance REAL)');
    Customer cust = new Customer(name: 'Smit Khokhariya', balance: 1000000.00);
  ...
  Future<List<Customer>> getCustomer() async {
    ...
    List<Map> maps = await dbClient
        .query('customerTable', columns: ['id', 'name', 'balance']);
